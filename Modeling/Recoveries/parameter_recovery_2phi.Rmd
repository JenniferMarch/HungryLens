...
This script contains the parameter recovery of the Multi-attribute attentional DDM our manuscript (https://osf.io/preprints/psyarxiv/wvfnb). It requires JAGS and the dwiener module. The script is structured s follows:
...
pr_sim_addmJAGS_2Phi <- function(parameters,tasteA,tasteB,healthA,healthB,subject,fixProps){
  ...
  for  (s in (unique(data_sated$subject))){
    ...
    for (t in 1:2){
      if (t == 1){ #session-specific stuff up front; note that order of parameters follows rtdists, not dwiener
        ...
        parameters <- c(log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$bound[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$bound_H[sInJAGS])),
                      log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$ndt[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$ndt_H[sInJAGS])),
                      log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$drift[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$drift_H[sInJAGS])),
                      pnorm(addmJAGS_2Phi$BUGSoutput$mean$weight1[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$weight1_H[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$theta[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$theta_H[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$phy[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$phy_H[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$phy2[sInJAGS]+addmJAGS_2Phi$BUGSoutput$mean$phy2_H[sInJAGS]))
      } else {
        sub <- data_sated[data_sated$subject == s, ] #sated
        fixatedElement <- expanded_table_s[[which(unique(data_sated$subject)==s)]]
        parameters <- c(log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$bound[sInJAGS])),
                      log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$ndt[sInJAGS])),
                      log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$drift[sInJAGS])),
                      pnorm(addmJAGS_2Phi$BUGSoutput$mean$weight1[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$theta[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$phy[sInJAGS]),
                      (addmJAGS_2Phi$BUGSoutput$mean$phy2[sInJAGS]))
      }
      ...
      #simulate
      simDat <- pr_sim_addmJAGS_2Phi(parameters,tasteAi,tasteBi,healthAi,healthBi,subjecti,fixProps)
      if (t==1){
...
T1<-Sys.time()
recov_addmJAGS_2Phi <- jags.parallel(ddmData,inits = NULL,#jags.seed = sample(100:999,1),
...
# check convergence
ddmRhats <- recov_addmJAGS_2Phi$BUGSoutput$summary[,8] #check with max(Rhats), which should ideally be < 1.01 (1.05 would also be okay)
max(ddmRhats)
recov_addmJAGS_2Phi$BUGSoutput$DIC
#max R_hat = 1.031; DIC = 67097.38
```

```{r}
save.image(file = "param_recov_2phi2.RData")
```

```{r}
#correlations sated and hungry for each parameter: bound, ndt, taste weight, drift, theta and phi1 and phi2
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$bound, addmJAGS_2Phi$BUGSoutput$mean$bound)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$bound+recov_addmJAGS_2Phi$BUGSoutput$mean$bound_H, addmJAGS_2Phi$BUGSoutput$mean$bound+addmJAGS_2Phi$BUGSoutput$mean$bound_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$ndt, addmJAGS_2Phi$BUGSoutput$mean$ndt)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$ndt+recov_addmJAGS_2Phi$BUGSoutput$mean$ndt_H, addmJAGS_2Phi$BUGSoutput$mean$ndt+addmJAGS_2Phi$BUGSoutput$mean$ndt_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$weight1, addmJAGS_2Phi$BUGSoutput$mean$weight1)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$weight1+recov_addmJAGS_2Phi$BUGSoutput$mean$weight1_H, addmJAGS_2Phi$BUGSoutput$mean$weight1+addmJAGS_2Phi$BUGSoutput$mean$weight1_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$theta, addmJAGS_2Phi$BUGSoutput$mean$theta)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$theta+recov_addmJAGS_2Phi$BUGSoutput$mean$theta_H, addmJAGS_2Phi$BUGSoutput$mean$theta+addmJAGS_2Phi$BUGSoutput$mean$theta_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$phy, addmJAGS_2Phi$BUGSoutput$mean$phy)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$phy+recov_addmJAGS_2Phi$BUGSoutput$mean$phy_H, addmJAGS_2Phi$BUGSoutput$mean$phy+addmJAGS_2Phi$BUGSoutput$mean$phy_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$phy2, addmJAGS_2Phi$BUGSoutput$mean$phy2)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$phy2+recov_addmJAGS_2Phi$BUGSoutput$mean$phy2_H, addmJAGS_2Phi$BUGSoutput$mean$phy2+addmJAGS_2Phi$BUGSoutput$mean$phy2_H)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$drift, addmJAGS_2Phi$BUGSoutput$mean$drift)
cor(recov_addmJAGS_2Phi$BUGSoutput$mean$drift+recov_addmJAGS_2Phi$BUGSoutput$mean$drift_H, addmJAGS_2Phi$BUGSoutput$mean$drift+addmJAGS_2Phi$BUGSoutput$mean$drift_H)
...
bound_rec <- data.frame(
  rec_sated = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$bound)),
  true_sated = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$bound)),
  rec_hungry = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$bound+recov_addmJAGS_2Phi$BUGSoutput$mean$bound_H)),
  true_hungry = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$bound+addmJAGS_2Phi$BUGSoutput$mean$bound_H))
)
...
# b) NDT
ndt_rec <- data.frame(
  rec_sated = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$ndt)),
  true_sated = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$ndt)),
  rec_hungry = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$ndt+recov_addmJAGS_2Phi$BUGSoutput$mean$ndt_H)),
  true_hungry = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$ndt+addmJAGS_2Phi$BUGSoutput$mean$ndt_H))
)
...
taste_rec <- data.frame(
  rec_sated = pnorm(recov_addmJAGS_2Phi$BUGSoutput$mean$weight1),
  true_sated = pnorm(addmJAGS_2Phi$BUGSoutput$mean$weight1),
  rec_hungry = pnorm(recov_addmJAGS_2Phi$BUGSoutput$mean$weight1+recov_addmJAGS_2Phi$BUGSoutput$mean$weight1_H),
  true_hungry = pnorm(addmJAGS_2Phi$BUGSoutput$mean$weight1+addmJAGS_2Phi$BUGSoutput$mean$weight1_H)
)
...
drift_rec <- data.frame(
  rec_sated = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$drift))/10,
  true_sated = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$drift)),
  rec_hungry = log(1+exp(recov_addmJAGS_2Phi$BUGSoutput$mean$drift+recov_addmJAGS_2Phi$BUGSoutput$mean$drift_H))/10,
  true_hungry = log(1+exp(addmJAGS_2Phi$BUGSoutput$mean$drift+addmJAGS_2Phi$BUGSoutput$mean$drift_H))
)
...
theta_rec <- data.frame(
  rec_sated = (recov_addmJAGS_2Phi$BUGSoutput$mean$theta),
  true_sated = (addmJAGS_2Phi$BUGSoutput$mean$theta),
  rec_hungry = (recov_addmJAGS_2Phi$BUGSoutput$mean$theta+recov_addmJAGS_2Phi$BUGSoutput$mean$theta_H),
  true_hungry = (addmJAGS_2Phi$BUGSoutput$mean$theta+addmJAGS_2Phi$BUGSoutput$mean$theta_H)
)
...
# f) phi 1
phi_rec <- data.frame(
  rec_sated = (recov_addmJAGS_2Phi$BUGSoutput$mean$phy),
  true_sated = (addmJAGS_2Phi$BUGSoutput$mean$phy),
  rec_hungry = (recov_addmJAGS_2Phi$BUGSoutput$mean$phy+recov_addmJAGS_2Phi$BUGSoutput$mean$phy_H),
  true_hungry = (addmJAGS_2Phi$BUGSoutput$mean$phy+addmJAGS_2Phi$BUGSoutput$mean$phy_H)
)
...
# g) phi 2
phi2_rec <- data.frame(
  rec_sated = (recov_addmJAGS_2Phi$BUGSoutput$mean$phy2),
  true_sated = (addmJAGS_2Phi$BUGSoutput$mean$phy2),
  rec_hungry = (recov_addmJAGS_2Phi$BUGSoutput$mean$phy2+recov_addmJAGS_2Phi$BUGSoutput$mean$phy2_H),
  true_hungry = (addmJAGS_2Phi$BUGSoutput$mean$phy2+addmJAGS_2Phi$BUGSoutput$mean$phy2_H)
)
...
# # f) starting point
# sp_rec <- data.frame(
#   rec_sated = pnorm(recov_addmJAGS_2Phi$BUGSoutput$mean$sp),
#   true_sated = pnorm(addmJAGS_2Phi$BUGSoutput$mean$sp),
#   rec_hungry = pnorm(recov_addmJAGS_2Phi$BUGSoutput$mean$sp+recov_addmJAGS_2Phi$BUGSoutput$mean$sp_H),
#   true_hungry = pnorm(addmJAGS_2Phi$BUGSoutput$mean$sp+addmJAGS_2Phi$BUGSoutput$mean$sp_H)
# )
# 
# # Plot
# sp_pr <-ggplot(sp_rec) +
...
recov_plot_maaddm2phi <- plot_grid(taste_pr, drift_pr, ndt_pr,bound_pr, theta_pr, phi_pr, phi2_pr, labels = c("a","b", "c", "d", "e", "f", "g"), label_size = 20, ncol = 4, align = "h")
