---
title: "parameter Recovery maaDDMsp"
...
```{r}
pr_addmJAGSsp  <- function(parameters,tasteA,tasteB,healthA,healthB,subject,fixProps){
...
nParamRecov <- 1
prSample <- sample(addmJAGS_sp$BUGSoutput$n.sims,nParamRecov)#draw samples from posterior (without replacement)
  ...
  for  (s in (unique(data_sated$subject))){
    ...
    for (t in 1:2){
      if (t == 1){ #session-specific stuff up front; note that order of parameters follows rtdists, not dwiener
        ...
        parameters <- c(log(1+exp(addmJAGS_sp$BUGSoutput$mean$bound[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$bound_H[sInJAGS])),
                      log(1+exp(addmJAGS_sp$BUGSoutput$mean$ndt[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$ndt_H[sInJAGS])),
                      log(1+exp(addmJAGS_sp$BUGSoutput$mean$drift[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$drift_H[sInJAGS])),
                      pnorm(addmJAGS_sp$BUGSoutput$mean$weight1[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$weight1_H[sInJAGS]),
                      (addmJAGS_sp$BUGSoutput$mean$theta[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$theta_H[sInJAGS]),
                      (addmJAGS_sp$BUGSoutput$mean$phy[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$phy_H[sInJAGS]),
                      pnorm(addmJAGS_sp$BUGSoutput$mean$sp[sInJAGS]+addmJAGS_sp$BUGSoutput$mean$sp_H[sInJAGS]))
      } else {
        sub <- data_sated[data_sated$subject == s, ] #sated
        fixatedElement <- expanded_table_s[[which(unique(data_sated$subject)==s)]]
        parameters <- c(log(1+exp(addmJAGS_sp$BUGSoutput$mean$bound[sInJAGS])),
                      log(1+exp(addmJAGS_sp$BUGSoutput$mean$ndt[sInJAGS])),
                      log(1+exp(addmJAGS_sp$BUGSoutput$mean$drift[sInJAGS])),
                      pnorm(addmJAGS_sp$BUGSoutput$mean$weight1[sInJAGS]),
                      (addmJAGS_sp$BUGSoutput$mean$theta[sInJAGS]),
                      (addmJAGS_sp$BUGSoutput$mean$phy[sInJAGS]),
                      pnorm(addmJAGS_sp$BUGSoutput$mean$sp[sInJAGS]))
      }
      ...
      #simulate
      pr_Dat <- pr_addmJAGSsp(parameters,tasteAi,tasteBi,healthAi,healthBi,subjecti,fixProps)
      if (t==1){
...
T1<-Sys.time()
addmJAGS_sp_recov <- jags.parallel(ddmData,inits = NULL,#jags.seed = sample(100:999,1),
...
# check convergence
ddmRhats <- addmJAGS_sp_recov$BUGSoutput$summary[,8] #check with max(Rhats), which should ideally be < 1.01 (1.05 would also be okay)
max(ddmRhats)
addmJAGS_sp_recov$BUGSoutput$DIC

save.image(file = "param_recov_maaDDMsp.RData")
```
...
cor(addmJAGS_sp_recov$BUGSoutput$mean$bound, addmJAGS_sp$BUGSoutput$mean$bound)
cor(addmJAGS_sp_recov$BUGSoutput$mean$bound+addmJAGS_sp_recov$BUGSoutput$mean$bound_H, addmJAGS_sp$BUGSoutput$mean$bound+addmJAGS_sp$BUGSoutput$mean$bound_H)
cor(addmJAGS_sp_recov$BUGSoutput$mean$ndt, addmJAGS_sp$BUGSoutput$mean$ndt)
cor(addmJAGS_sp_recov$BUGSoutput$mean$ndt+addmJAGS_sp_recov$BUGSoutput$mean$ndt_H, addmJAGS_sp$BUGSoutput$mean$ndt+addmJAGS_sp$BUGSoutput$mean$ndt_H)
cor(addmJAGS_sp_recov$BUGSoutput$mean$weight1, addmJAGS_sp$BUGSoutput$mean$weight1)
cor(addmJAGS_sp_recov$BUGSoutput$mean$weight1+addmJAGS_sp_recov$BUGSoutput$mean$weight1_H, addmJAGS_sp$BUGSoutput$mean$weight1+addmJAGS_sp$BUGSoutput$mean$weight1_H)

cor(addmJAGS_sp_recov$BUGSoutput$mean$theta, addmJAGS_sp$BUGSoutput$mean$theta)
cor(addmJAGS_sp_recov$BUGSoutput$mean$theta+addmJAGS_sp_recov$BUGSoutput$mean$theta_H, addmJAGS_sp$BUGSoutput$mean$theta+addmJAGS_sp$BUGSoutput$mean$theta_H)
cor(addmJAGS_sp_recov$BUGSoutput$mean$phy, addmJAGS_sp$BUGSoutput$mean$phy)
cor(addmJAGS_sp_recov$BUGSoutput$mean$phy+addmJAGS_sp_recov$BUGSoutput$mean$phy_H, addmJAGS_sp$BUGSoutput$mean$phy+addmJAGS_sp$BUGSoutput$mean$phy_H)

cor(addmJAGS_sp_recov$BUGSoutput$mean$drift, addmJAGS_sp$BUGSoutput$mean$drift)
cor((addmJAGS_sp_recov$BUGSoutput$mean$drift+addmJAGS_sp_recov$BUGSoutput$mean$drift_H), (addmJAGS_sp$BUGSoutput$mean$drift+addmJAGS_sp$BUGSoutput$mean$drift_H))

cor(addmJAGS_sp_recov$BUGSoutput$mean$sp, addmJAGS_sp$BUGSoutput$mean$sp)
cor((addmJAGS_sp_recov$BUGSoutput$mean$sp+addmJAGS_sp_recov$BUGSoutput$mean$sp_H), (addmJAGS_sp$BUGSoutput$mean$sp+addmJAGS_sp$BUGSoutput$mean$sp_H))
```
...
bound_rec <- data.frame(
  rec_sated = log(1+exp(addmJAGS_sp_recov$BUGSoutput$mean$bound)),
  true_sated = log(1+exp(addmJAGS_sp$BUGSoutput$mean$bound)),
  rec_hungry = log(1+exp(addmJAGS_sp_recov$BUGSoutput$mean$bound+addmJAGS_sp_recov$BUGSoutput$mean$bound_H)),
  true_hungry = log(1+exp(addmJAGS_sp$BUGSoutput$mean$bound+addmJAGS_sp$BUGSoutput$mean$bound_H))
)
...
# b) NDT
ndt_rec <- data.frame(
  rec_sated = log(1+exp(addmJAGS_sp_recov$BUGSoutput$mean$ndt)),
  true_sated = log(1+exp(addmJAGS_sp$BUGSoutput$mean$ndt)),
  rec_hungry = log(1+exp(addmJAGS_sp_recov$BUGSoutput$mean$ndt+addmJAGS_sp_recov$BUGSoutput$mean$ndt_H)),
  true_hungry = log(1+exp(addmJAGS_sp$BUGSoutput$mean$ndt+addmJAGS_sp$BUGSoutput$mean$ndt_H))
)
...
taste_rec <- data.frame(
  rec_sated = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$weight1),
  true_sated = pnorm(addmJAGS_sp$BUGSoutput$mean$weight1),
  rec_hungry = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$weight1+addmJAGS_sp_recov$BUGSoutput$mean$weight1_H),
  true_hungry = pnorm(addmJAGS_sp$BUGSoutput$mean$weight1+addmJAGS_sp$BUGSoutput$mean$weight1_H))
...
drift_rec <- data.frame(
  rec_sated = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$drift),
  true_sated = pnorm(addmJAGS_sp$BUGSoutput$mean$drift),
  rec_hungry = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$drift+addmJAGS_sp_recov$BUGSoutput$mean$drift_H),
  true_hungry = pnorm(addmJAGS_sp$BUGSoutput$mean$drift+addmJAGS_sp$BUGSoutput$mean$drift_H))
...
theta_rec <- data.frame(
  rec_sated = (addmJAGS_sp_recov$BUGSoutput$mean$theta),
  true_sated = (addmJAGS_sp$BUGSoutput$mean$theta),
  rec_hungry = (addmJAGS_sp_recov$BUGSoutput$mean$theta+addmJAGS_sp_recov$BUGSoutput$mean$theta_H),
  true_hungry = (addmJAGS_sp$BUGSoutput$mean$theta+addmJAGS_sp$BUGSoutput$mean$theta_H)
)
...
# f) phi
phi_rec <- data.frame(
  rec_sated = (addmJAGS_sp_recov$BUGSoutput$mean$phy),
  true_sated = (addmJAGS_sp$BUGSoutput$mean$phy),
  rec_hungry = (addmJAGS_sp_recov$BUGSoutput$mean$phy+addmJAGS_sp_recov$BUGSoutput$mean$phy_H),
  true_hungry = (addmJAGS_sp$BUGSoutput$mean$phy+addmJAGS_sp$BUGSoutput$mean$phy_H)
)
...
sp_rec <- data.frame(
  rec_sated = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$sp),
  true_sated = pnorm(addmJAGS_sp$BUGSoutput$mean$sp),
  rec_hungry = pnorm(addmJAGS_sp_recov$BUGSoutput$mean$sp+addmJAGS_sp_recov$BUGSoutput$mean$sp_H),
  true_hungry = pnorm(addmJAGS_sp$BUGSoutput$mean$sp+addmJAGS_sp$BUGSoutput$mean$sp_H))
...
recov_plot_maaddmsp <- plot_grid(taste_pr, drift_pr, ndt_pr,bound_pr, theta_pr, phi_pr, sp_pr, labels = c("a","b", "c", "d", "e", "f", "g"), label_size = 20, ncol = 4, align = "h")
recov_plot_maaddmsp
# Save the combined plot as a PNG file
ggsave("recov_plot_maaddmsp.png", recov_plot_maaddmsp, width = 18, height = 9)
```
