...
T1<-Sys.time()
addmJAGS_2Phi_nutri <- jags.parallel(ddmData,inits = NULL,#jags.seed = sample(100:999,1),
...
# check convergence
ddmRhats <- addmJAGS_2Phi_nutri$BUGSoutput$summary[,8] #check with max(Rhats), which should ideally be < 1.01 (1.05 would also be okay)
max(ddmRhats)
addmJAGS_2Phi_nutri$BUGSoutput$DIC
#max R_hat = 1.039; DIC = 65391

save.image("Fit_amaDDM_nutri.RData")
```

## 2.2 maaDDM_2Phi: check parameters (group posteriors)
```{r}
boundSep_S <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_bound))
boundSep_H <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_bound+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_bound_H))
boundSep_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_bound_H

ndt_S <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_ndt))
ndt_H <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_ndt+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_ndt_H))
ndt_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_ndt_H

drift_S <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_drift))
drift_H <- log(1+exp(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_drift+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_drift_H))
drift_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_drift_H

weight1_S <- pnorm(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_weight1)
weight1_H <- pnorm(addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_weight1+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_weight1_H)
weight1_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_weight1_H

theta_S <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_theta)
theta_H <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_theta+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_theta_H)
theta_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_theta_H

phy_S <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy)
phy_H <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy_H)
phy_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy_H

phy2_S <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy2)
phy2_H <- (addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy2+addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy2_H)
phy2_delta <- addmJAGS_2Phi_nutri$BUGSoutput$sims.list$mu_phy2_H
...
drift2<-ggplot(data_deltascale, aes(x = drift_delta)) +
  geom_histogram(binwidth = 1/45, fill = "grey", alpha = 0.5, color = "black") +
  geom_vline(xintercept = 0, color = "red", size = 1.5) +
...
ggsave("combined_plot_maaddm2phi_nutri.png", combined_plot_maaddm2phi2, width = 16, height = 12)
